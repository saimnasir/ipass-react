...
import { PaginationTenantFilterModel } from '../../models/paginationModel';
...
export const getMemoryTypes = async (pagination: PaginationTenantFilterModel): Promise<AxiosResponse<FinalResponse<ListResponse<MemoryTypeModel>>>> => {
