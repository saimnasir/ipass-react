...
export const createMemoryType = async (model: MemoryTypeModel): Promise<AxiosResponse<FinalResponse<boolean>>> => {
    return await http.post<any, AxiosResponse<FinalResponse<boolean>>>("/memorytypes", model);
};
